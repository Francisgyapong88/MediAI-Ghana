  ...
  return (
    <div>
      ...
      <div className="card" style={{ marginBottom: 20 }}>
        <div className="progress-steps" style={{ display: 'flex', alignItems: 'center', gap: 0 }}>
          {steps.map((s, i) => (
            <div key={s} style={{ display: 'flex', alignItems: 'center', flex: i < steps.length - 1 ? 1 : 'none' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, cursor: i < step ? 'pointer' : 'default' }} onClick={() => { if (i < step) setStep(i) }}>
                ...
                <span className="step-label" style={{ fontSize: 13, fontWeight: i === step ? 700 : 500, color: i < step ? '#16a34a' : i === step ? '#0a1628' : '#9ca3af', whiteSpace: 'nowrap' }}>
                  {s}
                </span>
              </div>
              {i < steps.length - 1 && (
                <div style={{ flex: 1, height: 1, background: i < step ? '#16a34a' : '#e2e8f0', margin: '0 12px', minWidth: 20 }} />
              )}
            </div>
          ))}
        </div>
      ...
      {step === 0 && (
        <div className="grid-sidebar" style={{ display: 'grid', gap: 20 }}>
          <div className="card">
      ...
      {/* Step 1 — Symptoms */}
      {step === 1 && (
        <div className="grid-sidebar-sm" style={{ display: 'grid', gap: 20 }}>
          <div>
            <div className="card" style={{ marginBottom: 16 }}>
              ...
              <div className="symptom-grid" style={{ display: 'grid', gap: 8 }}>
            ...
            <div className="action-row" style={{ display: 'flex', gap: 10, justifyContent: 'space-between' }}>
        ...
        <div className="grid-sidebar-sm" style={{ display: 'grid', gap: 20 }}>
          <div>
            <div className="card" style={{ marginBottom: 16 }}>
              ...
              <div className="grid-2col" style={{ display: 'grid', gap: 16, marginBottom: 20 }}>
              ...
              <div className="grid-2col" style={{ display: 'grid', gap: 14, marginBottom: 20 }}>
            ...
            <div className="card" style={{ marginBottom: 16 }}>
              ...
              {abstained ? (
                ...
                <div style={{ padding: '28px', background: 'linear-gradient(135deg, #0a1628, #0f2040)', border: '1px solid rgba(13,148,136,0.3)', borderRadius: 12, marginBottom: 20, textAlign: 'center' }}>
                  ...
                  <div style={{ fontSize: 'clamp(28px, 6vw, 42px)', fontWeight: 900, color: 'white', letterSpacing: '-0.02em', marginBottom: 16 }}>
              ...
              {/* Metadata */}
              <div className="grid-3col" style={{ display: 'grid', gap: 10, marginBottom: 20 }}>
                {[
      ...
      <style>{`
        ...
        .grid-sidebar-sm { grid-template-columns: 1fr 300px; }
